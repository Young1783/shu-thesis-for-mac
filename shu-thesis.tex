...
\centering
  \begin{tabular}{@{}cccc@{}}
    \includegraphics[width=.25\TeX twidth]{figures/mplot3d}  &
    \includegraphics[width=.25\TeX twidth]{figures/bar3d}  &
    \includegraphics[width=.25\TeX twidth]{figures/surface3d} &
    \includegraphics[width=.25\TeX twidth]{figures/trisurf3d} \\
    (a)M-plot 3D & (b)Bar-chart 3D & 
    (c)Surface 3D & (d) Tri-surface 3D \\
  \end{tabular}
\end{figure}
...
%\centering
%\begin{tabular}{@{}cc@{}}
%  \pgfplotsset{width=0.5\TeX twidth}
%  \begin{tikzpicture}
%    \begin{axis}[
%    hide axis,                              %隐藏坐标
%    colormap/cool,                          %颜色风格
...
\end{enumerate}
%\emph{IEEE Conference on Computer Vision and Pattern Recognition}(\TeX tbf{CVPR})，是计算机视觉领域三大国际顶级会议(CVPR, ECCV, ICCV)之一。
